...
class A{
	...
	A(int member){
		...
		System.out.println("전달받은 매개변수 값은" + member);
	}
	A(String member){
		System.out.println("슈퍼 부모 클래스 A의 스트링 매개변수생성자");
		System.out.println("전달받은 매개변수 값은" + member);
	}
}
class B extends A{
	...
	B(String member){
		super(member);
		System.out.println("B의 String 매개변수 생성자");
		System.out.println("전달받은 매개변수 값은" + member);
	}
...
class C extends B{
	...
	C(String member){
		super(member);
		System.out.println("C의 스트링 매개변수 생성자.");
		System.out.println("전달받은 매개변수 값은" + member);
	}
}
